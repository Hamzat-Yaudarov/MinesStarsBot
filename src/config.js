...
export const ADMIN_IDS = (process.env.ADMIN_IDS ? process.env.ADMIN_IDS.split(',').map(s=>Number(s.trim())).filter(Boolean) : [7910097562, 7972065986, 6752933671]).concat(ADMIN_ID ? [ADMIN_ID] : []);
